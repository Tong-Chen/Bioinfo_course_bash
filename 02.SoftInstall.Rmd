...
# 让自己的家目录只自己可见
ct@ysx:~$ chmod go-rwx /home/ct
ct@ysx:~$ ls -l /home
-rwx------ 1 ct ct 26 12月  7 2016  ct

# 同组人增加可读和可执行属性
ct@ysx:~$ chmod g+rx /home/ct
ct@ysx:~$ ls -l /home
-rwxr-x--- 1 ct ct 26 12月  7 2016  ct

# 所有人增加可读和可执行属性
ct@ysx:~$ chmod a+rx /home/ct
ct@ysx:~$ ls -l /home
-rwxr-xr-x 1 ct ct 26 12月  7 2016  ct
```
...
```{bash eval=F}
# 新建个文件
ct@ysx:~$ cat <<END >run.sh
> echo " I am a script created by ysx." 
> END
...
YSX@ysx:~/train/single_cell$ less Seurat.Rmd
```
...
# 再绝对一些
YSX@ysx:~/train/single_cell$ /home/YSX/train/metagenome/pipeline_metagenome.sh
```
...
```
YSX@ysx:~/train/single_cell$ export PATH=$PATH:/home/YSX/train/metagenome/:/home/YSX/train/amplicon/
```
...
见[R系列教程](http://www.ysx.com/Bioinfo_R_course)。
...
```
ct@ysx:~# source /anaconda3/bin/activate qiime2-2020.6
...
conda env create -f ysx_env.yml
```
...
# 如果有多个同名环境，可指定目录打包
# conda pack -p /path/my_env_name -o my_env_name.tar.gz
```
